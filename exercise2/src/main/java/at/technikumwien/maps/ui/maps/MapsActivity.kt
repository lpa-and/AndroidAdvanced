...
class MapsViewModel(private val drinkingFountainApi: DrinkingFountainApi) : ViewModel() {

    constructor(dependencyManager: AppDependencyManager) : this(dependencyManager.drinkingFountainApi)

    val drinkingFountains: MutableLiveData<List<DrinkingFountain>> = MutableLiveData()
    ...
    fun syncDrinkingFountains() {
        ...
        viewModelScope.launch {
            try {
                // Load drinking fountains from API
                val loadedFountains = drinkingFountainApi.getDrinkingFountains().drinkingFountains
                drinkingFountains.value = loadedFountains
